...
- [ ] **Persistence Layer:** Сохранение пользовательских рейтингов в базу данных PostgreSQL.
- [ ] **Система отзывов:** Возможность для пользователей оставлять текстовые отзывы о посещенных местах.
- [ ] **Личный кабинет:** Профиль пользователя с историей оценок и «избранными» курортами.
